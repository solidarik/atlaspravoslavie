    ...
    fillHeaderColumns(headerRow) {
        ...
        for (let iCol = 0; iCol < headerRow.length; iCol++) {
            ...
            for (let colModel in colCorresponds) {
                ...
                if (
                    xlsColName.startsWith(colSearch) &&
                    !headerColumns[colModel]
                ) {
        ...
        try {
            ...
            if (!birthDay && !deathDay) {
                ...
                if (birthDay != '') {
                    ...
                    if (maybeBirthDate) {
                        ...
                        json.warningArr.push(
                            `Не определена дата рождения ${birthDay}`
                        )
                    }
                }
                ...
                if (deathDay != '') {
                    ...
                    if (maybeDeathDate) {
                        ...
                        json.warningArr.push(
                            `Не определена дата смерти ${deathDay}`
                        )
                    }
                }
            ...
            if (
                ...
                if (birthCoord) {
                    ...
                    json.errorArr.push(
                        `Не определена координата рождения ${birthPlace}`
                    )
                }
                ...
                if (deathCoord) {
                    ...
                    json.errorArr.push(
                        `Не определена координата смерти ${deathPlace}`
                    )
                }
            }
            ...
            try {
                json.worshipDays = DateHelper.getWorshipDates(
                    row[headerColumns.worshipDays]
                )
            } catch (err) {
            ...
            if (inetHelper.isExistUrl(json.srcUrl)) {
                ...
                json.warningArr.push(
                    `Невалидная ссылка-источник: ${json.srcUrl}`
                )
            }
