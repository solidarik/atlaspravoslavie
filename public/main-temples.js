"use strict";
import addTemples from './addTemples.js';
window.app = {};
var app = window.app;
var slideIndex = 1;
...
$(document).ready(function () {
  ...
  $('#collapse-temples-button').on('click', function () {
    if ($('#collapse-temples-button').children().hasClass('mdi-chevron-double-up')) {
      $('#collapse-temples-button').children().removeClass('mdi-chevron-double-up').addClass('mdi-chevron-double-down');
    }
    else if ($('#collapse-temples-button').children().hasClass('mdi-chevron-double-down')) {
      $('#collapse-temples-button').children().removeClass('mdi-chevron-double-down').addClass('mdi-chevron-double-up');
    }
  });
});
