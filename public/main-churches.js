...
$(document).ready(function () {
  ...
  $('#collapse-churches-button').on('click', function () {
    if ($('#collapse-churches-button').children().hasClass('mdi-chevron-double-up')) {
      $('#collapse-churches-button').children().removeClass('mdi-chevron-double-up').addClass('mdi-chevron-double-down');
    }
    else if ($('#collapse-churches-button').children().hasClass('mdi-chevron-double-down')) {
      $('#collapse-churches-button').children().removeClass('mdi-chevron-double-down').addClass('mdi-chevron-double-up');
    }
  });
});
